...
- для просмотра книг онлайн использую сайт omnireader.ru. Это проект https://github.com/bookpauk/liberama.git<br>
  Это, конечно, не идеальный вариант. Надо бы просто прогонять книгу через какой-нибудь fb2-to-html парсер. Но мне для этого не хватает знаний.

Чуть не забыл самое главное изменение: клик по коту возвращает на главную страницу.
